...
## 導入
[Releases](https://github.com/Takenoko-II/ServerForm-Wrapper/releases/tag/v1.0.0)からダウンロードした.zipファイル内の`scripts/ServerForm-Wrapper.js`と`scripts/ServerForm-Wrapper.d.ts`をアドオンの`scripts`フォルダ内に入れて使用してください。
